...
const LeadeList = ({ data, setLoadin, dataGetFun }) => {
            ...
            {currentLeads.map((lead, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    data-label="Payment"
                    className="text-center py-2 px-2 primary3 f5  payment_hover position-relative"
                  >
                    {lead?.paid_amount > 0 && (
                      <div className="paydeta d-flex ac-jc flex-column rounded-3">
                        {lead?.balance_amount !== 0 && (
                          <p className="mb-0 py-2 white fs-xxl-10 fs-xl-10 fs-lg-10 fs-sm-10 fs-xs-10 textani f3">
                            <span className="green">
                              {lead?.interested_course?.amount}
                            </span>
                            /
                            <span className="red"> {lead?.balance_amount}</span>
                          </p>
                        )}
                      </div>
                    )}
